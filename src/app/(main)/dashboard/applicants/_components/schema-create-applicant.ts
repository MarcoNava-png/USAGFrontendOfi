...
export const createApplicantSchema = z.object({
  ...
  aspiranteStatusId: z.coerce.number().int().optional(),
  ...
  cuatrimestreInteres: z.coerce.number().int().min(1).max(99).optional(),
  ...
  puestoEmpresa: z.string().optional(),
  quienCubreGastos: z.string().optional(),
  celular: z.string().max(10).optional(),
  nombreContactoEmergencia: z.string().max(150).optional(),
  telefonoContactoEmergencia: z.string().max(20).optional(),
  parentescoContactoEmergencia: z.string().max(50).optional(),
});
